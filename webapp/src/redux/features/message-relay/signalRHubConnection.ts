...
// //   const connectionHubUrl = new URL(
// //     "/messageRelayHub",
...
// //   hubConnection.on(
// //     SignalRCallbackMethods.UserJoined,
...
// //       };
// //       store.dispatch({
// //         type: "conversations/addUserToConversation",
// //         payload: { user, chatId },
// //       });
// //     }
// //   );
...
// //   hubConnection.on(
// //     SignalRCallbackMethods.GlobalDocumentUploaded,
// //     (fileNames: string, userName: string) => {
// //       store.dispatch(
// //         addAlert({
// //           message: `${userName} uploaded ${fileNames} to all chats`,
// //           type: AlertType.Info,
// //         })
// //       );
// //     }
...
// //     }
// //     store.dispatch({
// //       type: "conversations/editConversationTitle",
...
// //   hubConnection.on(
// //     SignalRCallbackMethods.ChatDeleted,
// //     (chatId: string, userId: string) => {
...
// //           userId !== store.getState().app.activeUserInfo?.id;
